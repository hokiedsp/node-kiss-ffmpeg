...
Object.defineProperty(FFmpeg, "command", {
  ...
  set: function(p) {
    this._command = utils.which(p) ? p : utils.which("ffmpeg", "FFMPEG_PATH");
  }
});
FFmpeg.command = utils.which("FFmpeg", "FFMPEG_PATH"); // initialize
...
Object.defineProperty(FFmpeg, "getDemuxerInfo", {
  value: name => caps.getDemuxerInfo(FFmpeg.spawnSyncUtf8, name)
});
Object.defineProperty(FFmpeg, "getMuxerInfo", {
  value: name => caps.getMuxerInfo(FFmpeg.spawnSyncUtf8, name)
});
