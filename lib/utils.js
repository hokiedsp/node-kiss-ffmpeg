...
function strsignal_win(num) {
  switch (num) {
    case 22: return "SIGABRT";
    case 8: return "SIGFPE";
    case 4: return "SIGILL";
    case 2: return "SIGINT";
    case 11: return "SIGSEGV";
    case 15: return "SIGTERM";
    case 21: return "SIGBREAK";
    case 6: return "SIGABRT_COMPAT";
    default: throw new Error("Unknown Signal")
  }
}

function strsignal(num) {
  return "SIG" + spawnSync("kill", ["-l", String(num)], { encoding: "utf8", shell: true }).stdout.slice(0, -1);
}
